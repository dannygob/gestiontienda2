...
import com.example.gestiontienda2.data.remote.firebase.datasource.source.ServiceExpenseFirebaseDataSource
    ...
    override fun getServiceExpenses(): Flow<List<ServiceExpenseFirebase>> {
        return serviceExpensesCollection.snapshots().map { querySnapshot ->
            querySnapshot.documents.mapNotNull { documentSnapshot ->
                documentSnapshot.toObject(ServiceExpenseFirebase::class.java)
